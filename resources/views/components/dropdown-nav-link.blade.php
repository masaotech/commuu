...
@php
    $is___Active = 'transition duration-200 ease-in-out block w-full text-gray-700 border-l-4 px-4 py-2 ';
    $isNotActive = 'transition duration-200 ease-in-out block w-full text-gray-700 border-l-4 px-4 py-2 ';
